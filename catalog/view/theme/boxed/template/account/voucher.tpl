      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <?php if (isset($help_message)) {?><span class="help-block"><?php echo $help_message; ?></span><?php }?> </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="input-amount"><?php echo $entry_amount; ?></label>
          <div class="col-sm-10">
            <input type="text" name="amount" value="<?php echo $amount; ?>" id="input-amount" class="form-control" size="5" />
            <?php if (isset($help_message)) {?><span class="help-block"><?php echo $help_amount; ?></span><?php }?>
            <?php if ($error_amount) { ?>
