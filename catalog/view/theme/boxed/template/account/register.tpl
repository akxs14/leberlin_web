  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group"  id="company-id-display">
            ...
            <div class="col-sm-10">
              ...
              <?php if (isset($error_company_id) && $error_company_id) { ?>
        ...
        <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" <?php if (isset($custom_field['sort_order'])) {?>data-sort="<?php echo $custom_field['sort_order']; ?>"<?php }?>>
...
<?php foreach ($customer_groups as $customer_group) { ?>
	...
	customer_group[<?php echo $customer_group['customer_group_id']; ?>]['company_id_display'] = '<?php if (isset($customer_group['company_id_display'])) echo $customer_group['company_id_display']; ?>';
	customer_group[<?php echo $customer_group['customer_group_id']; ?>]['company_id_required'] = '<?php if (isset($customer_group['company_id_required']))  echo $customer_group['company_id_required']; ?>';
	customer_group[<?php echo $customer_group['customer_group_id']; ?>]['tax_id_display'] = '<?php if (isset($customer_group['tax_id_display']))  echo $customer_group['tax_id_display']; ?>';
	customer_group[<?php echo $customer_group['customer_group_id']; ?>]['tax_id_required'] = '<?php if (isset($customer_group['tax_id_required'])) echo $customer_group['tax_id_required']; ?>';
<?php } ?>	
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=<?php if ($opencart_version >= 2000) {?>account/account/country<?php } else { ?>account/register/country<?php }?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('input[name=\'customer_group_id\']').on('change', function() {
	$.ajax({
		url: <?php if ($opencart_version >= 2000) {?>'index.php?route=account/register/customfield&customer_group_id=' + this.value<?php } else {?>'index.php?route=account/register/custom_field&customer_group_id=' + this.value<?php }?>,
		dataType: 'json',	
		success: function(json) {
			$('.custom-field').hide();
