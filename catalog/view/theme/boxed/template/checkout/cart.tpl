            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <?php /* onclick="cart.remove('<?php echo $product['key']; ?>');"*/?> <?php if ($opencart_version >= 2000) {?>onclick="cart.remove('<?php if ($opencart_version < 2100) echo $product['key'];else echo $product['cart_id']; ?>');"<?php } else {?>href="<?php echo $product['remove']; ?>"<?php }?>><i class="fa fa-times-circle"></i></a></span></div></td>
