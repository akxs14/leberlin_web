		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
			...
			<h3><?php if (isset($nicosocialauth['text'])) 
			{
				...
				if (isset($nicosocialauth['text'][$current_lang])) $text = $nicosocialauth['text'][$current_lang]; else if (isset($nicosocialauth['text']['en'])) $text = $nicosocialauth['text']['en']; else $text = '';
				echo $text; 
