	 ...
	 <div class="navbar-collapse collapse">
		<ul class="nav nav-pills nav-stacked">
			...
			<li class="<?php if ($category['menu_type'] != 'text' && $category['full_width'] == 1) {?>mega<?php }?>
						...
						<?php if ((isset($category['children']) && !empty($category['children'])) || $category['menu_type'] != 'text' ) {?> dropdown <?php if ($level == 0){?>dropdown-menu<?php } else if ($level > 1 && isset($category['children'])) {?>dropdown-submenu<?php } }?>"
				>
