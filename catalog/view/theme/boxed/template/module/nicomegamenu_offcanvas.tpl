	 ...
	 <div class="navbar-collapse collapse">
		...
		<div class="nav navbar-nav">
			...
			foreach($categories as $category)
			{
				...
				$i++;
			?>
			<a href="<?php if ((isset($category['children']) && !empty($category['children'])) || $category['menu_type'] != 'text' ) echo '#p' . $i; else if(isset($category['url'])) echo $category['url'];?>" class="list-group-item <?php if ($category['highlight'] == 1) {?>highlight<?php }?>" <?php if ((isset($category['children']) && !empty($category['children'])) || $category['menu_type'] != 'text' ) {?>data-toggle="collapse"<?php }?>>	<?php if (isset($category['font_icon']) && $category['font_icon']) {?><b class="font_icon fa <?php echo $category['font_icon'];?>"></b><?php }?>
