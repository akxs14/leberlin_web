    ...
    <div class="product">
	  ...
	  <?php } ?>
			...
			<div class="hover">
				 <div>
					 <a href="<?php echo $product['href']; ?>" >
						...
						<span class="description"><?php if (isset($product['description'])) echo $product['description']; ?></span>				    
						<?php if ($product['price']) { ?>
						<span class="price<?php if ($product['special']) { ?> price_sale<?php }?>">
					  ...
					  <span  class="add-to-cart" onclick="event.preventDefault();event.stopPropagation();addToCart('<?php echo $product['product_id']; ?>'); return false"><i class="fa fa-shopping-cart"></i></span>
					  <?php } else { ?>
					  <span class="add-to-cart" onclick="event.preventDefault();event.stopPropagation();return false"><?php echo $product['stock_status']; ?></span>
					  <?php }} else { ?>
					 <span  class="add-to-cart" onclick="event.preventDefault();event.stopPropagation();addToCart('<?php echo $product['product_id']; ?>'); return false"><i class="fa fa-shopping-cart"></i></span>
					  <?php }?>
		...
		<button class="btn btn-primary btn-sm" onclick="return addToCart('<?php echo $product['product_id']; ?>');"><?php echo $_button_cart; ?></button>
		  <?php } else { ?>
		  <button class="btn btn-primary btn-sm" onclick="event.preventDefault();event.stopPropagation();return false"><?php echo $product['stock_status']; ?></button>
		  <?php }} else { ?>
		  <button class="btn btn-primary btn-sm" onclick="return addToCart('<?php echo $product['product_id']; ?>');"><?php echo $_button_cart; ?></button>
		  <?php }?>
	    </div>
