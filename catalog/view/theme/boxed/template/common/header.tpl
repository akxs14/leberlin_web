...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	...
	<?php 
		...
		$_nico_head_script ['common'][] = 'catalog/view/theme/' .$theme_directory. '/js/grid3d.js';
		...
		{?><link href='//fonts.googleapis.com/css?family=<?php if ($google_fonts = nico_get_config('google_fonts')) echo  str_replace('|','%7C',$google_fonts);else echo str_replace('|','%7C','Montserrat:200,300,400,600,700|Open+Sans|Varela|Lato');?>' rel='stylesheet' type='text/css'/><?php }  
		
		$_nico_head_style ['common'][] = 'catalog/view/theme/' .$theme_directory. '/css/style.css';
		$_nico_head_style ['common'][] = 'catalog/view/theme/' .$theme_directory. '/css/theme.css';
		...
		$_nico_head_style ['common'][] = 'catalog/view/theme/' .$theme_directory. '/css/3dgrid.css';
		...
		if (defined('DEMO') && DEMO && strpos($_SERVER['HTTP_HOST'], 'boxed2') !== false) {$settings_css_file_name = 'editor_settings2.css';}

		$is_css_file_writable = is_readable(DIR_TEMPLATE . $theme_directory . 'css/' . $settings_css_file_name) && is_writable($theme_directory . 'css/' . $settings_css_file_name);
...
<?php if (isset($error) && $error) { ?>
    ...
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/boxed/img/close.png" alt="" class="close" /></div>
...
<div id="top">
  ...
  <div class="container">
	...
	<?php } ?>
	  ...
	  <?php if ($opencart_version >= 2000) echo $search; else {?>
