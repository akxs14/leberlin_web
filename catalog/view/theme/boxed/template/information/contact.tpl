            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-sm-3"><strong><?php echo $location['name']; ?></strong><br />
                  ...
                  <a href="https://maps.google.com/maps?q=<?php echo urlencode($location['geocode']); ?>&hl=<?php if (isset($geocode_hl)) echo $geocode_hl;else echo 'en'; ?>&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
                  <?php } ?>
                </div>
