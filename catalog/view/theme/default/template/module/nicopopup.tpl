...
switch ($popup_type)
{
	...
	<div role="alert" class="alert alert-warning alert-dismissible fade in text-center">
      <div class="container">
		  ...
		  <?php if ($visibility == "checkbox") {?><br/><input type="checkbox" name="visibility" onclick="popup_checkbox('<?php echo $popup_module_id;?>', this.checked)"> <label for="visibility"><?php echo $checkbox_text;?></label>&nbsp;&nbsp;<?php }?>
	...
	?>
		...
		<div class="modal fade" id="<?php echo $popup_module_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
		  <div class="modal-dialog" role="document" >
      		<div class="modal-content" style="background-image:url(<?php echo $background_image;?>)">
