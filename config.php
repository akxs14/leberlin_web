<?php 
// HTTP
define('HTTP_SERVER', 'http://leberlin.herokuapp.com/opencart');
define('HTTP_IMAGE', 'http://leberlin.herokuapp.com/opencartimage/');
define('HTTP_ADMIN', 'http://leberlin.herokuapp.com/opencartadmin/');
// HTTPS
define('HTTPS_SERVER', 'http://leberlin.herokuapp.com/opencart');
